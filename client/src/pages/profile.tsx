...
import { Card, CardHeader, CardContent, CardTitle, CardDescription, Badge, Separator, Button, Avatar } from "@/components/ui";
// کامپوننت‌های ساده
import { 
  User, 
  Mail, 
...
export default function Profile() {
  const { data: user, isLoading } = useQuery<{ id: number; username?: string; name?: string } | undefined>({
    queryKey: ["/api/user/1"],
  });
