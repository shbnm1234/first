...
export default function MediaPlayerPage() {
  ...
  const mediaSafe = {
    ...
    contentUrl: (media as any).contentUrl || '',
    instructorName: (media as any).instructorName || '',
    instructorTitle: (media as any).instructorTitle || '',
    instructorAvatar: (media as any).instructorAvatar || '',
  };
